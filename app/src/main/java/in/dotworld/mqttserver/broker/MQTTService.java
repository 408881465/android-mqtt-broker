...
import in.dotworld.mqttserver.MainActivity;
import in.dotworld.mqttserver.R;

import static in.dotworld.mqttserver.broker.MQTTNotificationBroker.CHANNEL_ID;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                    .setContentTitle("Dotworld Technologies")
